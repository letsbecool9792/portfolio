            ...
            <div className="mt-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 z-10">
                {sideQuests.map((quest, i) => (
                    <motion.div
                        ...
                        className="relative bg-no-repeat bg-cover text-black shadow-xl rounded-xl p-10 sm:p-12 mx-auto w-full max-w-xs h-[460px] font-serif flex flex-col justify-center"
                        style={{
